...
var whatsappParams_1 = require('./whatsappParams');
var CeiboShare = (function () {
    function CeiboShare() {
        this.sharers = {
            ...
            whatsapp: {
                shareUrl: 'https://web.whatsapp.com/send',
                /*params: {
    ...
    __decorate([
        core_1.Input(),
        __metadata('design:type', whatsappParams_1.WhatsappParams)
    ], CeiboShare.prototype, "whatsapp", void 0);
    __decorate([
        core_1.Input(),
